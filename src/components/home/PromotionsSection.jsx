    ...
    <section className="py-20 lg:py-28 bg-accent/40">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-semibold mb-4">
          ...
          <div className="relative bg-card rounded-3xl border-2 border-primary/30 shadow-xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl mb-6">
                ...
                <span className="text-sm font-semibold text-amber-700">{p.validUntil}: 01.11.2026</span>
              </div>
