  ...
  try {
    ...
    const i18n = {
      ...
      en: {
        ...
        cancelled: { subject: 'Booking Cancelled - Limpiezas LD', message: 'Your booking has been <strong>cancelled</strong>. If you have any questions, please contact us.' },
      ...
      de: {
        ...
        cancelled: { subject: 'Buchung storniert - Limpiezas LD', message: 'Ihre Buchung wurde <strong>storniert</strong>. Bei Fragen kontaktieren Sie uns bitte.' },
