  ...
  try {
    ...
    const i18n = {
      ...
      it: {
        ...
        cancelled: { subject: 'Prenotazione annullata - Limpiezas LD', message: 'La tua prenotazione è stata <strong>annullata</strong>. Attualmente offriamo i nostri servizi ad <strong>Águilas, Región de Murcia</strong> e dintorni. Se la tua posizione è al di fuori di quest\'area o hai domande, non esitare a contattarci.' },
      ...
      nl: {
        ...
        cancelled: { subject: 'Boeking geannuleerd - Limpiezas LD', message: 'Uw boeking is <strong>geannuleerd</strong>. Wij bieden onze diensten momenteel aan in <strong>Águilas, Regio Murcia</strong> en omgeving. Als uw locatie buiten dit gebied valt of u vragen heeft, neem dan gerust contact met ons op.' },
